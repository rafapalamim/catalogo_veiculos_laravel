...
const CarItem: React.FC<PropsWithChildren<CarItemProps>> = (props: CarItemProps) => {
    return (
        <div className="w-4/12">
            <div className="m-2 rounded shadow-sm shadow-gray-400 hover:shadow-md hover:shadow-gray-500 cursor-pointer transition-shadow">
                <div>
                    <img className="rounded-t" src={props.foto ?? "https://placehold.co/300x200"} />
                </div >
